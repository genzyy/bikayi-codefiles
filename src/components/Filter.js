...
const Filter = ({ categories, filterCat, filterYear, setFilterCat, setFilterYear}) => {
  ...
  useEffect(() => {
    ...
    return (
        <div className=' grid grid-cols-3 gap-3'>
            <div>
                <span className='flex'>
                                    <h1 className='capitalize mx-1 text-md'>Filter with year</h1><button className='text-xs rounded-md shadow-sm text-white bg-black py-1 px-2' onClick={() => { setFilterYear('all') }}>Clear Year Filter (Set to {filterYear})</button>
                                    </span>
                <input
    type="range"
    className="
